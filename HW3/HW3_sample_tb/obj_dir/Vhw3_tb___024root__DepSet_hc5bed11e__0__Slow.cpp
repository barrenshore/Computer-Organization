...
VL_ATTR_COLD void Vhw3_tb___024root___ctor_var_reset(Vhw3_tb___024root* vlSelf) {
    ...
    vlSelf->hw3_tb__DOT__core_top_inst__DOT__beq_addr = VL_RAND_RESET_I(32);
    vlSelf->hw3_tb__DOT__core_top_inst__DOT__instr = VL_RAND_RESET_I(32);
    ...
    vlSelf->hw3_tb__DOT__core_top_inst__DOT__rdst = VL_RAND_RESET_I(32);
    ...
    vlSelf->hw3_tb__DOT__core_top_inst__DOT____Vcellout__decode_inst__ssel = VL_RAND_RESET_I(2);
    vlSelf->hw3_tb__DOT__core_top_inst__DOT____Vcellout__decode_inst__jump_type = VL_RAND_RESET_I(2);
    for (int __Vi0=0; __Vi0<16; ++__Vi0) {
